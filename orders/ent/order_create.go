...
func (oc *OrderCreate) SetNillableProductID(id *uuid.UUID) *OrderCreate {
	if id != nil {
...
func (oc *OrderCreate) check() error {
	...
	if _, ok := oc.mutation.ExpiresAt(); !ok {
		return &ValidationError{Name: "expires_at", err: errors.New(`ent: missing required field "Order.expires_at"`)}
	}
