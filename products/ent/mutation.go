...
func (m *ProductMutation) SetOrderID(u uuid.UUID) {
	m.order_id = &u
}

// OrderID returns the value of the "order_id" field in the mutation.
func (m *ProductMutation) OrderID() (r uuid.UUID, exists bool) {
	v := m.order_id
	if v == nil {
		return
	}
...
// OldOrderID returns the old "order_id" field's value of the Product entity.
// If the Product object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProductMutation) OldOrderID(ctx context.Context) (v *uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProductMutation) ClearOrderID() {
	m.order_id = nil
	m.clearedFields[product.FieldOrderID] = struct{}{}
}

// OrderIDCleared returns if the "order_id" field was cleared in this mutation.
func (m *ProductMutation) OrderIDCleared() bool {
	_, ok := m.clearedFields[product.FieldOrderID]
	return ok
}

// ResetOrderID resets all changes to the "order_id" field.
func (m *ProductMutation) ResetOrderID() {
	m.order_id = nil
	delete(m.clearedFields, product.FieldOrderID)
}
...
func (m *ProductMutation) Fields() []string {
	...
	if m.order_id != nil {
		fields = append(fields, product.FieldOrderID)
	}
	if m.version != nil {
...
func (m *ProductMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(product.FieldOrderID) {
		fields = append(fields, product.FieldOrderID)
	}
	return fields
}
